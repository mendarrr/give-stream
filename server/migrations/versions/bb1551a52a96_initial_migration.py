...
Revision ID: bb1551a52a96
Revises: 
Create Date: 2024-08-15 09:31:40.490285
...
def upgrade():
    ...
    sa.Column('amount', sa.Float(), nullable=False),
    sa.Column('charity_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['charity_id'], ['charities.id'], name=op.f('fk_reminder_charity_id_charities')),
    sa.ForeignKeyConstraint(['donor_id'], ['donors.id'], name=op.f('fk_reminder_donor_id_donors')),
    sa.PrimaryKeyConstraint('id')
    )
